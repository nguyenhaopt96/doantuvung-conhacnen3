...
- Có kho nhạc dùng chung lưu tại máy chủ: tải nhiều bài, nghe thử, xóa và dùng
  lại mà không phải gửi kèm nhạc trong từng lô.
- Mỗi lô có thể tắt nhạc, chọn một bài cố định hoặc để máy chủ xáo kho nhạc và
  gán ngẫu nhiên cho từng video; âm lượng chỉnh được từ 0–100%.
- Nhạc ngắn tự lặp, được cắt đúng thời lượng và trộn vào AAC 48 kHz trong cùng
  tiến trình FFmpeg với giọng đọc và tiếng tích tắc.
