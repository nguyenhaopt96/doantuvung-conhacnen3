...
import { registerMusicLibraryRoutes } from './server/musicLibrary';
...
async function startServer() {
  ...
  // Music uploads live in the server workspace so every browser/device that
  // opens this PandaStack app sees the same reusable music library.
